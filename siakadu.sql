...
ALTER TABLE "registrasi" ADD CONSTRAINT "fk_regis_id_dosen" FOREIGN KEY ("id_dosen_pa") REFERENCES "dosen" ("id_dosen") ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE "registrasi" ADD CONSTRAINT "fk_regis_id_mahasiswa" FOREIGN KEY ("id_mahasiswa") REFERENCES "mahasiswa" ("id_mahasiswa") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "transkrip" ADD CONSTRAINT "fk_transkrip_id_regis" FOREIGN KEY ("id_registrasi") REFERENCES "registrasi" ("id_registrasi") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "presensi_pertemuan" ADD CONSTRAINT "fk_presensi_id_jadwal" FOREIGN KEY ("id_jadwal") REFERENCES "jadwal" ("id_jadwal");
...
ALTER TABLE "presensi_pertemuan" ADD CONSTRAINT "fk_presensi_id_dosen" FOREIGN KEY ("id_dosen") REFERENCES "dosen" ("id_dosen");
...
ALTER TABLE "prodi" ADD CONSTRAINT "fk_prodi_id_jenjang" FOREIGN KEY ("id_jenjang") REFERENCES "jenjang" ("id_jenjang");

ALTER TABLE "registrasi" ADD CONSTRAINT "fk_regis_id_status" FOREIGN KEY ("id_status") REFERENCES "status_mahasiswa" ("id_status");

ALTER TABLE "presensi_mahasiswa" ADD CONSTRAINT "fk_presensi_mahasiswa_id_status" FOREIGN KEY ("id_status") REFERENCES "status_kehadiran" ("id_status");

ALTER TABLE "nilai" ADD CONSTRAINT "fk_nilai_id_aturan" FOREIGN KEY ("id_aturan") REFERENCES "aturan_penilaian" ("id_aturan");

ALTER TABLE "aturan_penilaian" ADD CONSTRAINT "fk_aturan_id_jenis_nilai" FOREIGN KEY ("id_jenis_nilai") REFERENCES "jenis_nilai" ("id_jenis_nilai");

ALTER TABLE "aturan_penilaian" ADD CONSTRAINT "fk_aturan_id_kelas" FOREIGN KEY ("id_kelas") REFERENCES "kelas" ("id_kelas");
